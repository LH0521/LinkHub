...
function displayResults(results) {
    ...
    results.forEach((item) => {
        ...
        card.className = 'card shadow-4-hover';
...
function openLinkCanvas(name, linkDisplay, linkId, icon, kinks, preview) {
    ...
    loadUserRating(linkId);
}

function loadUserRating(linkId) {
